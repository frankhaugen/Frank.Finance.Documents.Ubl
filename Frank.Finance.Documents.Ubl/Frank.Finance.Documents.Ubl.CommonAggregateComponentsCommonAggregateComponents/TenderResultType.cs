...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe the awarding of a tender in a tendering process.
    ///                    </ccts:Definition><ccts:ObjectClass>Tender Result</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class TenderResultType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Tender_ Result Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the result of the tendering process.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tender Result</ccts:ObjectClass><ccts:PropertyTermQualifier>Tender</ccts:PropertyTermQualifier><ccts:PropertyTerm>Result Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("TenderResultCode", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.TenderResultCodeType TenderResultCode { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Advertisement. Amount</ccts:DictionaryEntryName><ccts:Definition>The monetary value of the advertisement for this tendering process.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tender Result</ccts:ObjectClass><ccts:PropertyTerm>Advertisement</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("AdvertisementAmount", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AdvertisementAmountType AdvertisementAmount { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AwardDateType AwardDate { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AwardTimeType AwardTime { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Received_ Tender. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The total number of tenders received in this tendering process.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ReceivedTenderQuantityType ReceivedTenderQuantity { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Lower_ Tender. Amount</ccts:DictionaryEntryName><ccts:Definition>The least expensive tender received in the tendering process.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LowerTenderAmountType LowerTenderAmount { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Higher_ Tender. Amount</ccts:DictionaryEntryName><ccts:Definition>The most expensive tender received in this tendering process.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.HigherTenderAmountType HigherTenderAmount { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Received_ Electronic Tender Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The number of electronic tenders received.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tender Result</ccts:ObjectClass><ccts:PropertyTermQualifier>Received</ccts:PropertyTermQualifier><ccts:PropertyTerm>Electronic Tender Quantity</ccts:PropertyTerm><ccts:RepresentationTerm>Quantity</ccts:RepresentationTerm><ccts:DataType>Quantity. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ReceivedElectronicTenderQuantityType ReceivedElectronicTenderQuantity { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Received_ Foreign Tender Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The number of foreing tenders received.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tender Result</ccts:ObjectClass><ccts:PropertyTermQualifier>Received</ccts:PropertyTermQualifier><ccts:PropertyTerm>Foreign Tender Quantity</ccts:PropertyTerm><ccts:RepresentationTerm>Quantity</ccts:RepresentationTerm><ccts:DataType>Quantity. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ReceivedForeignTenderQuantityType ReceivedForeignTenderQuantity { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Awarded_ Tendered Project. Tendered Project
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The awarded tendered project associated with this tender result.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Contract Formalization_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which a contract associated with the awarded project is
        ///                                to be formalized.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tender Result. Winning Party</ccts:DictionaryEntryName><ccts:Definition>A party that is identified as the awarded by a tender result.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tender Result</ccts:ObjectClass><ccts:PropertyTerm>Winning Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Winning Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Winning Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
