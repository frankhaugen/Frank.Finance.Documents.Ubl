...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class PriceListType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Price List. Status Code. Code</ccts:DictionaryEntryName><ccts:Definition>A code signifying whether this price list is an original, copy, revision,
        ///                                or cancellation.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Price List</ccts:ObjectClass><ccts:PropertyTerm>Status Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType><ccts:Examples>new - announcement only , new and available , deleted - announcement only
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.StatusCodeType StatusCode { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Price List. Previous_ Price List. Price List
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The previous price list.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Price List</ccts:ObjectClass><ccts:PropertyTermQualifier>Previous</ccts:PropertyTermQualifier><ccts:PropertyTerm>Price List</ccts:PropertyTerm><ccts:AssociatedObjectClass>Price List</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Price List</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
