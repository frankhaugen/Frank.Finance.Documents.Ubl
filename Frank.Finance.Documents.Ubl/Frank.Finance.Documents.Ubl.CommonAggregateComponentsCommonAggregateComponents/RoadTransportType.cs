...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class RoadTransportType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Road Transport. License Plate Identifier. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The license plate identifier of this vehicle.</ccts:Definition><ccts:Cardinality>1</ccts:Cardinality><ccts:ObjectClass>Road Transport</ccts:ObjectClass><ccts:PropertyTerm>License Plate Identifier</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Vehicle registration number (WCO ID 167)
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LicensePlateIdType LicensePlateId { get; set; }
    }
}
