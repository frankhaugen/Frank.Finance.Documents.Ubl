...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class CreditAccountType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Credit Account. Account Identifier. Identifier
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AccountIdType AccountId { get; set; }
    }
}
