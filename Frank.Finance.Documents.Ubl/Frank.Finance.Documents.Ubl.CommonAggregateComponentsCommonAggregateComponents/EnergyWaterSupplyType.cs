...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Energy Water Supply. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe the supply (and therefore consumption) of an amount of energy
    ///                        or water.
    ///                    </ccts:Definition><ccts:ObjectClass>Energy Water Supply</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class EnergyWaterSupplyType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Energy Water Supply. Consumption Average
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A consumption average.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Energy Water Supply</ccts:ObjectClass><ccts:PropertyTerm>Consumption Average</ccts:PropertyTerm><ccts:AssociatedObjectClass>Consumption Average</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Consumption Average</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Energy Water Supply. Energy Water_ Consumption Correction.
        ///                                Consumption Correction
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Describes any corrections or adjustments to the supply of energy or
        ///                                water.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Energy Water Supply</ccts:ObjectClass><ccts:PropertyTermQualifier>Energy Water</ccts:PropertyTermQualifier><ccts:PropertyTerm>Consumption Correction</ccts:PropertyTerm><ccts:AssociatedObjectClass>Consumption Correction</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Consumption Correction</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
