...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class TendererRequirementType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tenderer Requirement. Tenderer Requirement_ Type Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying this requirement.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tenderer Requirement</ccts:ObjectClass><ccts:PropertyTermQualifier>Tenderer Requirement</ccts:PropertyTermQualifier><ccts:PropertyTerm>Type Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.TendererRequirementTypeCodeType TendererRequirementTypeCode { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tenderer Requirement. Legal Reference. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The legal reference of the exclusion criterion.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tenderer Requirement</ccts:ObjectClass><ccts:PropertyTerm>Legal Reference</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType><ccts:Examples>Art. 45 2 b</ccts:Examples></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("LegalReference", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LegalReferenceType LegalReference { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<EvidenceType> _suggestedEvidence;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tenderer Requirement. Suggested_ Evidence. Evidence
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An item of evidence that should be submitted to satisfy this requirement.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tenderer Requirement</ccts:ObjectClass><ccts:PropertyTermQualifier>Suggested</ccts:PropertyTermQualifier><ccts:PropertyTerm>Evidence</ccts:PropertyTerm><ccts:AssociatedObjectClass>Evidence</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Evidence</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
