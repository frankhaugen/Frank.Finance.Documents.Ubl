...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Event Line Item. Details</ccts:DictionaryEntryName><ccts:Definition>A class to define a line item describing the expected impacts associated with a
    ///                        retail event involving a specific product at a specific location.
    ///                    </ccts:Definition><ccts:ObjectClass>Event Line Item</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class EventLineItemType
    {
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LineNumberNumericType LineNumberNumeric { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Event Line Item. Participating Locations_ Location. Location
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The location of the stores involved in the event described in this line
        ///                                item.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Event Line Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Participating Locations</ccts:PropertyTermQualifier><ccts:PropertyTerm>Location</ccts:PropertyTerm><ccts:AssociatedObjectClass>Location</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Location</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Event Line Item. Retail Planned Impact</ccts:DictionaryEntryName><ccts:Definition>A planned impact of the event described in this line item.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Event Line Item</ccts:ObjectClass><ccts:PropertyTerm>Retail Planned Impact</ccts:PropertyTerm><ccts:AssociatedObjectClass>Retail Planned Impact</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Retail Planned Impact</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
