...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Completed Task. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe the completion of a specific task in the tendering process.
    ///                    </ccts:Definition><ccts:ObjectClass>Completed Task</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class CompletedTaskType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Completed Task. Annual_ Average. Amount</ccts:DictionaryEntryName><ccts:Definition>The average monetary amount of a task such as this completed task.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Completed Task</ccts:ObjectClass><ccts:PropertyTermQualifier>Annual</ccts:PropertyTermQualifier><ccts:PropertyTerm>Average</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("AnnualAverageAmount", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AnnualAverageAmountType AnnualAverageAmount { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.TotalTaskAmountType TotalTaskAmount { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Completed Task. Party Capacity. Amount</ccts:DictionaryEntryName><ccts:Definition>A monetary amount corresponding to the financial capacity of the party that
        ///                                carried out this completed task.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Completed Task</ccts:ObjectClass><ccts:PropertyTerm>Party Capacity</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("PartyCapacityAmount", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PartyCapacityAmountType PartyCapacityAmount { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Completed Task. Evidence Supplied</ccts:DictionaryEntryName><ccts:Definition>The evidence justifying a designation of "complete" for this task.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Completed Task</ccts:ObjectClass><ccts:PropertyTerm>Evidence Supplied</ccts:PropertyTerm><ccts:AssociatedObjectClass>Evidence Supplied</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Evidence Supplied</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Completed Task. Recipient_ Customer Party. Customer Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The original customer for this completed task.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Completed Task</ccts:ObjectClass><ccts:PropertyTermQualifier>Recipient</ccts:PropertyTermQualifier><ccts:PropertyTerm>Customer Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Customer Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Customer Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
