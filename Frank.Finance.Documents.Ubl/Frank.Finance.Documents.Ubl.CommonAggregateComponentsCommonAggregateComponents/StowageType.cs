...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Stowage. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe a location on board a means of transport where specified goods
    ///                        or transport equipment have been stowed or are to be stowed.
    ///                    </ccts:Definition><ccts:ObjectClass>Stowage</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class StowageType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Stowage. Location Identifier. Identifier
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LocationIdType LocationId { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LocationType> _location;
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LocationType> Location
        {
            get
            {
                return _location;
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Stowage. Measurement_ Dimension. Dimension
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A measurable dimension (length, mass, weight, or volume) of this stowage.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Stowage</ccts:ObjectClass><ccts:PropertyTermQualifier>Measurement</ccts:PropertyTermQualifier><ccts:PropertyTerm>Dimension</ccts:PropertyTerm><ccts:AssociatedObjectClass>Dimension</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Dimension</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
