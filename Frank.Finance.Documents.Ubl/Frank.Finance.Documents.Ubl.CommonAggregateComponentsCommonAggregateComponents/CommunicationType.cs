...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class CommunicationType
    {
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ChannelCodeType ChannelCode { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ChannelType Channel { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Communication. Value. Text</ccts:DictionaryEntryName><ccts:Definition>An identifying value (phone number, email address, etc.) for this channel
        ///                                of communication
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Communication</ccts:ObjectClass><ccts:PropertyTerm>Value</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType><ccts:Examples>+44 1 2345 6789 president@whitehouse.com</ccts:Examples></ccts:Component></para>
        /// </summary>
