...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class SignatureType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Signature. Note. Text</ccts:DictionaryEntryName><ccts:Definition>Free-form text conveying information that is not contained explicitly in
        ///                                other structures; in particular, information regarding the circumstances in which the
        ///                                signature is being used.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Signature</ccts:ObjectClass><ccts:PropertyTerm>Note</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Signature. Validator. Identifier</ccts:DictionaryEntryName><ccts:Definition>An identifier for the organization, person, service, or server that
        ///                                verified this signature.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Signature</ccts:ObjectClass><ccts:PropertyTerm>Validator</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Signature. Canonicalization Method. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The method used to perform XML canonicalization of this signature.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Signature</ccts:ObjectClass><ccts:PropertyTerm>Canonicalization Method</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.CanonicalizationMethodType CanonicalizationMethod { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.SignatureMethodType SignatureMethod { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Signature. Digital Signature_ Attachment. Attachment
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The actual encoded signature (e.g., in XMLDsig format).</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Signature</ccts:ObjectClass><ccts:PropertyTermQualifier>Digital Signature</ccts:PropertyTermQualifier><ccts:PropertyTerm>Attachment</ccts:PropertyTerm><ccts:AssociatedObjectClass>Attachment</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Attachment</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("DigitalSignatureAttachment")]
        public AttachmentType DigitalSignatureAttachment { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Signature. Original_ Document Reference. Document Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to the document that the signature applies to. For evidentiary
        ///                                purposes, this may be the document image that the signatory party saw when applying
        ///                                their signature.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Signature</ccts:ObjectClass><ccts:PropertyTermQualifier>Original</ccts:PropertyTermQualifier><ccts:PropertyTerm>Document Reference</ccts:PropertyTerm><ccts:AssociatedObjectClass>Document Reference</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Document Reference</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
