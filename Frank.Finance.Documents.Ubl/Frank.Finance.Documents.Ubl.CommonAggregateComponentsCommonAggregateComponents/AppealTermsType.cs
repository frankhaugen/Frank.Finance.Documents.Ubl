...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Appeal Terms. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe the terms and conditions, set by the contracting authority,
    ///                        under which an appeal can be lodged for a tender award.
    ///                    </ccts:Definition><ccts:ObjectClass>Appeal Terms</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class AppealTermsType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Appeal Terms. Presentation_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which an appeal can be presented.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Appeal Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Presentation</ccts:PropertyTermQualifier><ccts:PropertyTerm>Period</ccts:PropertyTerm><ccts:AssociatedObjectClass>Period</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Period</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("PresentationPeriod")]
        public PeriodType PresentationPeriod { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Appeal Terms. Appeal Information_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The party presenting the information for an appeal.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Appeal Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Appeal Information</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("AppealInformationParty")]
        public PartyType AppealInformationParty { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Appeal Terms. Appeal Receiver_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The party to whom an appeal should be presented.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Appeal Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Appeal Receiver</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
