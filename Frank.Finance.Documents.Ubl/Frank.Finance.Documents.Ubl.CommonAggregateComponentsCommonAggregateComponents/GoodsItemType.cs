...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class GoodsItemType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Sequence Number. Identifier</ccts:DictionaryEntryName><ccts:Definition>A sequence number differentiating a specific goods item within a
        ///                                consignment.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTerm>Sequence Number</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Description. Text</ccts:DictionaryEntryName><ccts:Definition>Text describing this goods item to identify it for customs, statistical, or
        ///                                transport purposes.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTerm>Description</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Description of goods (WCO ID 137)
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Hazardous Risk_ Indicator. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indication that the transported goods item is subject to an
        ///                                international regulation concerning the carriage of dangerous goods (true) or not
        ///                                (false).
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Declared Customs_ Value. Amount
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The total declared value for customs purposes of the goods item.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Declared Customs</ccts:PropertyTermQualifier><ccts:PropertyTerm>Value</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType><ccts:AlternativeBusinessTerms>For Customs Value (WCO ID 108)
        ///                            </ccts:AlternativeBusinessTerms></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Declared For Carriage_ Value. Amount
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The value of this goods item, declared by the shipper or his agent solely
        ...
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Declared For Carriage</ccts:PropertyTermQualifier><ccts:PropertyTerm>Value</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Interest in delivery, declared value for carriage
        ///                            </ccts:AlternativeBusinessTerms></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Declared Statistics_ Value. Amount
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The total declared value of all the goods items in the same consignment
        ///                                with this goods item that have the same statistical heading.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Declared Statistics</ccts:PropertyTermQualifier><ccts:PropertyTerm>Value</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Statistical Value (WCO ID 114)
        ///                            </ccts:AlternativeBusinessTerms></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Free On Board_ Value. Amount
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ValueAmountType ValueAmount { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Gross_ Weight. Measure</ccts:DictionaryEntryName><ccts:Definition>The weight of this goods item, including packing and packaging but
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Net_ Weight. Measure</ccts:DictionaryEntryName><ccts:Definition>The weight of this goods item, excluding packing but including packaging
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Net Net_ Weight. Measure</ccts:DictionaryEntryName><ccts:Definition>The total weight of this goods item, excluding all packing and packaging.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Gross_ Volume. Measure</ccts:DictionaryEntryName><ccts:Definition>The volume of this goods item, normally calculated by multiplying its
        ///                                maximum length, width, and height.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Gross</ccts:PropertyTermQualifier><ccts:PropertyTerm>Volume</ccts:PropertyTerm><ccts:RepresentationTerm>Measure</ccts:RepresentationTerm><ccts:DataType>Measure. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Volume, Gross Measurement Cube (GMC), Cube (WCO ID 134)
        ///                            </ccts:AlternativeBusinessTerms></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Net_ Volume. Measure</ccts:DictionaryEntryName><ccts:Definition>The volume contained by a goods item, excluding the volume of any packaging
        ///                                material.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Preference Criterion Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the treatment preference for this goods item according to
        ///                                international trading agreements.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTerm>Preference Criterion Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType><ccts:Examples>Preference Criterion is used in the following manner in the paper CO of
        ///                                another country (e.g.):
        ///                                A - The good is wholly obtained or produced entirely in the territory of one or more of
        ///                                the NAFTA countries as reference in Article 415. Note: The purchase of a good in the
        ///                                territory does not necessarily render it wholly obtained or produced . If the good is an
        ///                                agricultural good, see also criterion F and Annex 703.2. (Reference: Article 401(a),
        ///                                415).
        ///                                B - ...
        ///                                C - ...
        ///                                D - ...
        ...
        ///                                above and is not subjected to quantitative restriction in the importing NAFTA country
        ///                                because....
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PreferenceCriterionCodeType PreferenceCriterionCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Required_ Customs Identifier. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An identifier for a set of tariff codes required to specify a type of goods
        ///                                for customs, transport, statistical, or other regulatory purposes.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Required</ccts:PropertyTermQualifier><ccts:PropertyTerm>Customs Identifier</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Tariff code extensions (WCO ID 255)
        ///                            </ccts:AlternativeBusinessTerms></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("RequiredCustomsID", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.RequiredCustomsIdType RequiredCustomsId { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Customs Status Code. Code</ccts:DictionaryEntryName><ccts:Definition>A code assigned by customs to signify the status of this goods item.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTerm>Customs Status Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType><ccts:AlternativeBusinessTerms>Customs status of goods (WCO ID 094)
        ///                            </ccts:AlternativeBusinessTerms></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("CustomsStatusCode", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.CustomsStatusCodeType CustomsStatusCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Customs Tariff Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Quantity of the units in this goods item as required by customs for tariff,
        ///                                statistical, or fiscal purposes.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTerm>Customs Tariff Quantity</ccts:PropertyTerm><ccts:RepresentationTerm>Quantity</ccts:RepresentationTerm><ccts:DataType>Quantity. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("CustomsTariffQuantity", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.CustomsTariffQuantityType CustomsTariffQuantity { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Customs Import_ Classified Indicator. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indicator that this goods item has been classified for import by customs
        ///                                (true) or not (false).
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.CustomsImportClassifiedIndicatorType CustomsImportClassifiedIndicator { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Chargeable_ Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The number of units in the goods item to which charges apply.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ChargeableQuantityType ChargeableQuantity { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Returnable_ Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The number of units in the goods item that may be returned.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ReturnableQuantityType ReturnableQuantity { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Trace_ Identifier. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An identifier for use in tracing this goods item, such as the EPC number
        ///                                used in RFID.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Goods Item Container</ccts:DictionaryEntryName><ccts:Definition>The transporting of a goods item in a unit of transport equipment (e.g.,
        ///                                container).
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Freight_ Allowance Charge. Allowance Charge
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A cost incurred by the shipper in moving goods, by whatever means, from one
        ///                                place to another under the terms of the contract of carriage. In addition to transport
        ///                                costs, this may include such elements as packing, documentation, loading, unloading, and
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Invoice Line</ccts:DictionaryEntryName><ccts:Definition>Information about an invoice line relating to this goods item.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTerm>Invoice Line</ccts:PropertyTerm><ccts:AssociatedObjectClass>Invoice Line</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Invoice Line</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Contained_ Goods Item. Goods Item
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A goods item contained in this goods item.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Contained</ccts:PropertyTermQualifier><ccts:PropertyTerm>Goods Item</ccts:PropertyTerm><ccts:AssociatedObjectClass>Goods Item</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Goods Item</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Origin_ Address. Address</ccts:DictionaryEntryName><ccts:Definition>The region in which the goods have been produced or manufactured, according
        ///                                to criteria laid down for the purposes of application of the customs tariff, or of
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Measurement_ Dimension. Dimension
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A measurable dimension (length, mass, weight, or volume) of this goods
        ///                                item.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Containing_ Package. Package
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A package containing this goods item.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Containing</ccts:PropertyTermQualifier><ccts:PropertyTerm>Package</ccts:PropertyTerm><ccts:AssociatedObjectClass>Package</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Package</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Shipment_ Document Reference. Document Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a shipping document associated with this goods item.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Minimum_ Temperature. Temperature
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Information about minimum temperature.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Minimum</ccts:PropertyTermQualifier><ccts:PropertyTerm>Temperature</ccts:PropertyTerm><ccts:AssociatedObjectClass>Temperature</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Temperature</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("MinimumTemperature")]
        public TemperatureType MinimumTemperature { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Goods Item. Maximum_ Temperature. Temperature
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Information about maximum temperature.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Goods Item</ccts:ObjectClass><ccts:PropertyTermQualifier>Maximum</ccts:PropertyTermQualifier><ccts:PropertyTerm>Temperature</ccts:PropertyTerm><ccts:AssociatedObjectClass>Temperature</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Temperature</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
