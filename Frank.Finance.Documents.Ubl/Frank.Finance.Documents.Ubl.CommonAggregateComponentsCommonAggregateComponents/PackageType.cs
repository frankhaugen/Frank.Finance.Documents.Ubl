...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class PackageType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Package. Returnable Material_ Indicator. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indicator that the packaging material is returnable (true) or not
        ///                                (false).
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Package</ccts:ObjectClass><ccts:PropertyTermQualifier>Returnable Material</ccts:PropertyTermQualifier><ccts:PropertyTerm>Indicator</ccts:PropertyTerm><ccts:RepresentationTerm>Indicator</ccts:RepresentationTerm><ccts:DataType>Indicator. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ReturnableMaterialIndicatorType ReturnableMaterialIndicator { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PackageLevelCodeType PackageLevelCode { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PackagingTypeCodeType PackagingTypeCode { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PackingMaterialType> _packingMaterial;
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PackingMaterialType> PackingMaterial
        {
            get
            {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Package. Trace_ Identifier. Identifier</ccts:DictionaryEntryName><ccts:Definition>An identifier for use in tracing this package, such as the EPC number used
        ///                                in RFID.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Package. Containing_ Transport Equipment. Transport Equipment
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The piece of transport equipment containing this package.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Package</ccts:ObjectClass><ccts:PropertyTermQualifier>Containing</ccts:PropertyTermQualifier><ccts:PropertyTerm>Transport Equipment</ccts:PropertyTerm><ccts:AssociatedObjectClass>Transport Equipment</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Transport Equipment</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Package. Measurement_ Dimension. Dimension
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A measurable dimension (length, mass, weight, or volume) of this package.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Package</ccts:ObjectClass><ccts:PropertyTermQualifier>Measurement</ccts:PropertyTermQualifier><ccts:PropertyTerm>Dimension</ccts:PropertyTerm><ccts:AssociatedObjectClass>Dimension</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Dimension</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
