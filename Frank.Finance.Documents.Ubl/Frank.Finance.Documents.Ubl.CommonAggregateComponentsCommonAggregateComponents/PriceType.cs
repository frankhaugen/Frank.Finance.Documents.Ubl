...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class PriceType
    {
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceAmountType PriceAmount { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.BaseQuantityType BaseQuantity { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceChangeReasonType> _priceChangeReason;
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceChangeReasonType> PriceChangeReason
        {
            get
            {
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceTypeCodeType PriceTypeCode { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceTypeType PriceTypeProperty { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Price. Orderable Unit Factor. Rate</ccts:DictionaryEntryName><ccts:Definition>The factor by which the base price unit can be converted to the orderable
        ///                                unit.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Price</ccts:ObjectClass><ccts:PropertyTerm>Orderable Unit Factor</ccts:PropertyTerm><ccts:RepresentationTerm>Rate</ccts:RepresentationTerm><ccts:DataType>Rate. Type</ccts:DataType><ccts:Examples>Nails are priced by weight but ordered by quantity. So this would say how
        ///                                many nails per kilo
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.OrderableUnitFactorRateType OrderableUnitFactorRate { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Price. Pricing_ Exchange Rate. Exchange Rate
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The exchange rate applicable to this price, if it differs from the exchange
        ///                                rate applicable to the document as a whole.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Price</ccts:ObjectClass><ccts:PropertyTermQualifier>Pricing</ccts:PropertyTermQualifier><ccts:PropertyTerm>Exchange Rate</ccts:PropertyTerm><ccts:AssociatedObjectClass>Exchange Rate</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Exchange Rate</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
