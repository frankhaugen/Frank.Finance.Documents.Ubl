...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class TenderingTermsType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Awarding Method Type Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the awarding method in a tendering process (e.g., a
        ///                                method favoring the tender with the lowest price or the tender that is most economically
        ///                                advantageous).
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AwardingMethodTypeCodeType AwardingMethodTypeCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Price Evaluation Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Textual description of the legal form required for potential tenderers.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceEvaluationCodeType PriceEvaluationCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Maximum Variant_ Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Maximum number of variants the tenderer is allowed to present for this
        ///                                tendering project.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.MaximumVariantQuantityType MaximumVariantQuantity { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Variant_ Constraint. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indicator that variants are allowed and unconstrained in number (true)
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.VariantConstraintIndicatorType VariantConstraintIndicator { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AcceptedVariantsDescriptionType> _acceptedVariantsDescription;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Accepted Variants_ Description. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Text specifying the things for which variants are accepted.
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AcceptedVariantsDescriptionType> AcceptedVariantsDescription
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceRevisionFormulaDescriptionType> _priceRevisionFormulaDescription;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Price Revision_ Formula Description. Text
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PriceRevisionFormulaDescriptionType> PriceRevisionFormulaDescription
        {
            get
            {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Funding_ Program Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The program that funds the tendering process (e.g., "National",
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.FundingProgramCodeType FundingProgramCode { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.FundingProgramType> _fundingProgram;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Funding_ Program. Text</ccts:DictionaryEntryName><ccts:Definition>The program that funds the tendering process (e.g., EU 6th Framework
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.FundingProgramType> FundingProgram
        {
            get
            {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Maximum_ Advertisement. Amount
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The maximum advertised monetary value of the tendering process.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.MaximumAdvertisementAmountType MaximumAdvertisementAmount { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.NoteType> _note;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Note. Text</ccts:DictionaryEntryName><ccts:Definition>Free-form text conveying information that is not contained explicitly in
        ///                                other structures.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTerm>Note</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Payment Frequency Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the frequency of payment in the contract associated with
        ///                                the tendering process.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTerm>Payment Frequency Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("PaymentFrequencyCode", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PaymentFrequencyCodeType PaymentFrequencyCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Economic Operator Registry_ URI. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The Uniform Resource Identifier (URI) of an electronic registry of economic
        ///                                operators.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.EconomicOperatorRegistryUriType EconomicOperatorRegistryUri { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Required Curricula. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indicator that tenderers are required to provide a curriculum vitae for
        ///                                each participant in the project (true) or are not so required (false).
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTerm>Required Curricula</ccts:PropertyTerm><ccts:RepresentationTerm>Indicator</ccts:RepresentationTerm><ccts:DataType>Indicator. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.RequiredCurriculaIndicatorType RequiredCurriculaIndicator { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Other_ Conditions. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Indicates whether other conditions exist (true) or not (false). If the
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.OtherConditionsIndicatorType OtherConditionsIndicator { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AdditionalConditionsType> _additionalConditions;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Additional_ Conditions. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Other existing conditions.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Additional</ccts:PropertyTermQualifier><ccts:PropertyTerm>Conditions</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("AdditionalConditions", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.AdditionalConditionsType> AdditionalConditions
        {
            get
            {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Latest_ Security Clearance Date. Date
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The end date until which the candidates can obtain the necessary level of
        ///                                security clearance.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LatestSecurityClearanceDateType LatestSecurityClearanceDate { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Documentation Fee Amount. Amount
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The amount to be paid to obtain the contract documents and additional
        ///                                documentation.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTerm>Documentation Fee Amount</ccts:PropertyTerm><ccts:RepresentationTerm>Amount</ccts:RepresentationTerm><ccts:DataType>Amount. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.DocumentationFeeAmountType DocumentationFeeAmount { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<ClauseType> _penaltyClause;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Penalty_ Clause. Clause
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The penalty clauses</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Penalty</ccts:PropertyTermQualifier><ccts:PropertyTerm>Clause</ccts:PropertyTerm><ccts:AssociatedObjectClass>Clause</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Clause</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Required_ Financial Guarantee. Financial
        ///                                Guarantee
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A financial guarantee of a tenderer or bid submitter's actual entry into a
        ///                                contract in the event that it is the successful bidder.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Procurement Legislation_ Document Reference.
        ///                                Document Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a document providing references to procurement legislation
        ///                                applicable to the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Fiscal Legislation_ Document Reference. Document
        ///                                Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a document providing references to fiscal legislation
        ///                                applicable to the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Environmental Legislation_ Document Reference.
        ///                                Document Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a document providing references to environmental legislation
        ///                                applicable to the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Employment Legislation_ Document Reference.
        ///                                Document Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a document providing references to employment legislation
        ///                                applicable to the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Contractual_ Document Reference. Document
        ///                                Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a document that will become part of the awarded contract.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Call For Tenders_ Document Reference. Document
        ///                                Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to the Call for Tender associated with these tendering terms.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Warranty Validity_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which a warranty for work, service, or goods associated
        ///                                with these tendering terms is valid.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Payment Terms</ccts:DictionaryEntryName><ccts:Definition>A specification of payment terms associated with the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Tenderer Qualification Request
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Required set of qualifications for a tenderer in this tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Tender Preparation</ccts:DictionaryEntryName><ccts:Definition>Directions for preparing a tender for the+D2057 tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Contract Execution Requirement
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A requirement relating to execution of the contract that will be awarded as
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Awarding Terms</ccts:DictionaryEntryName><ccts:Definition>The terms in the tendering process for awarding the contract for a
        ///                                project.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Additional Information_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A party that has additional information about the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Document Provider_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The party that has the contract documents for the tendering process.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Document Provider</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Tender Recipient_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The party to which tenders should be presented.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Tender Recipient</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("TenderRecipientParty")]
        public PartyType TenderRecipientParty { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Contract Responsible_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The party responsible for the execution of the contract.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Contract Responsible</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Tender Evaluation_ Party. Party
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A party in the contracting authority responsible for evaluating tenders
        ///                                received.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTermQualifier>Tender Evaluation</ccts:PropertyTermQualifier><ccts:PropertyTerm>Party</ccts:PropertyTerm><ccts:AssociatedObjectClass>Party</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Party</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Tender Validity_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which tenders submitted for this tendering process must
        ///                                remain valid.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Contract Acceptance_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period of time during which the contracting authority may accept a
        ///                                contract.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Appeal Terms</ccts:DictionaryEntryName><ccts:Definition>Information about the terms to present for an appeal against a tender
        ///                                award.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTerm>Appeal Terms</ccts:PropertyTerm><ccts:AssociatedObjectClass>Appeal Terms</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Appeal Terms</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Language</ccts:DictionaryEntryName><ccts:Definition>One of the default languages specified for the tendering process.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tendering Terms</ccts:ObjectClass><ccts:PropertyTerm>Language</ccts:PropertyTerm><ccts:AssociatedObjectClass>Language</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Language</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Budget Account Line</ccts:DictionaryEntryName><ccts:Definition>A budget account line associated with the tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Terms. Replaced Notice_ Document Reference. Document
        ///                                Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A class defining a reference to the notice that is being replaced.
