...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Promotional Specification. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe a promotional event as a set of item locations that share a set
    ///                        of promotional tactics.
    ///                    </ccts:Definition><ccts:ObjectClass>Promotional Specification</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class PromotionalSpecificationType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Promotional Specification. Specification Identifier. Identifier
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.SpecificationIdType SpecificationId { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<PromotionalEventLineItemType> _promotionalEventLineItem;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Promotional Specification. Promotional Event Line Item
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A line item for a promotional event involving a specific product at a
        ///                                specific location; it describes the expected impacts associated with the event and
        ///                                specifies the promotional price of the item."
        ///                            </ccts:Definition><ccts:Cardinality>1..n</ccts:Cardinality><ccts:ObjectClass>Promotional Specification</ccts:ObjectClass><ccts:PropertyTerm>Promotional Event Line Item</ccts:PropertyTerm><ccts:AssociatedObjectClass>Promotional Event Line Item</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Promotional Event Line Item</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
