...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Event Tactic. Details</ccts:DictionaryEntryName><ccts:Definition>A class defining a specific type of action or situation arranged by the Buyer or
    ///                        the Seller to promote the product or products.
    ///                    </ccts:Definition><ccts:ObjectClass>Event Tactic</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class EventTacticType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Event Tactic. Comment. Text</ccts:DictionaryEntryName><ccts:Definition>Generic field to add additional information or to specify mutually defined
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Event Tactic. Quantity</ccts:DictionaryEntryName><ccts:Definition>The currencies, units, etc. that describes what is need for the event or
        ///                                promotion Usage example: Number of pallets per store for a stack display
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Event Tactic</ccts:ObjectClass><ccts:PropertyTerm>Quantity</ccts:PropertyTerm><ccts:RepresentationTerm>Quantity</ccts:RepresentationTerm><ccts:DataType>Quantity. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
