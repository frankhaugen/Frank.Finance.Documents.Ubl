...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Customs Declaration. Details</ccts:DictionaryEntryName><ccts:Definition>A class describing identifiers or references relating to customs procedures.
    ///                    </ccts:Definition><ccts:ObjectClass>Customs Declaration</ccts:ObjectClass><ccts:Examples>Movement Reference Number, Local Reference Number</ccts:Examples></ccts:Component></para>
    /// </summary>
    ...
    public partial class CustomsDeclarationType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Customs Declaration. Issuer_ Party. Party
