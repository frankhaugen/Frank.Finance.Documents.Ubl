...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Renewal. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe the renewal of a commercial arrangement, such as a contract or
    ///                        licence fee.
    ///                    </ccts:Definition><ccts:ObjectClass>Renewal</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
