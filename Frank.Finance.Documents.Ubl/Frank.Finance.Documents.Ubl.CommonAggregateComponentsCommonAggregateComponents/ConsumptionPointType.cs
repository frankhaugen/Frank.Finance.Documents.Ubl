...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class ConsumptionPointType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Point. Subscriber Identifier. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An identifier for the subscriber responsible for the consumption at this
        ///                                consumption point.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Consumption Point</ccts:ObjectClass><ccts:PropertyTerm>Subscriber Identifier</ccts:PropertyTerm><ccts:RepresentationTerm>Identifier</ccts:RepresentationTerm><ccts:DataType>Identifier. Type</ccts:DataType><ccts:Examples>98143211</ccts:Examples></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Point. Subscriber Type. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The type of subscriber, expressed as text.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Consumption Point</ccts:ObjectClass><ccts:PropertyTerm>Subscriber Type</ccts:PropertyTerm><ccts:RepresentationTerm>Text</ccts:RepresentationTerm><ccts:DataType>Text. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Point. Subscriber Type Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The type of subscriber, expressed as a code.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Consumption Point</ccts:ObjectClass><ccts:PropertyTerm>Subscriber Type Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType><ccts:Examples>APL</ccts:Examples></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Point. Total_ Delivered Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The total quantity delivered, calculated at this consumption point.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Consumption Point</ccts:ObjectClass><ccts:PropertyTermQualifier>Total</ccts:PropertyTermQualifier><ccts:PropertyTerm>Delivered Quantity</ccts:PropertyTerm><ccts:RepresentationTerm>Quantity</ccts:RepresentationTerm><ccts:DataType>Quantity. Type</ccts:DataType><ccts:Examples>5761.00</ccts:Examples></ccts:Component></para>
        /// </summary>
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.TotalDeliveredQuantityType TotalDeliveredQuantity { get; set; }
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Point. Web Site Access</ccts:DictionaryEntryName><ccts:Definition>Access information for the website of this consumption point.
        ///                            </ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Consumption Point</ccts:ObjectClass><ccts:PropertyTerm>Web Site Access</ccts:PropertyTerm><ccts:AssociatedObjectClass>Web Site Access</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Web Site Access</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Consumption Point. Utility_ Meter. Meter
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A meter at this consumption point.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Consumption Point</ccts:ObjectClass><ccts:PropertyTermQualifier>Utility</ccts:PropertyTermQualifier><ccts:PropertyTerm>Meter</ccts:PropertyTerm><ccts:AssociatedObjectClass>Meter</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Meter</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
