...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Contracting Party. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe an individual, a group, or a body having a procurement role in
    ///                        a tendering process.
    ///                    </ccts:Definition><ccts:ObjectClass>Contracting Party</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class ContractingPartyType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Contracting Party. Buyer Profile_ URI. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The buyer profile is typically located on a web site where the contracting
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.BuyerProfileUriType BuyerProfileUri { get; set; }
        
        [XmlIgnoreAttribute()]
        private List<ContractingPartyTypeType> _contractingPartyTypeProperty;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Contracting Party. Contracting Party Type
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The type of contracting party that is independent of its role.
        ///                            </ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Contracting Party</ccts:ObjectClass><ccts:PropertyTerm>Contracting Party Type</ccts:PropertyTerm><ccts:AssociatedObjectClass>Contracting Party Type</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Contracting Party Type</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
