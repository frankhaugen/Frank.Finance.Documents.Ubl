...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Declaration. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe a declaration by an economic operator of certain
    ///                        characteristics or capabilities in fulfilment of requirements specified in a call for tenders.
    ///                    </ccts:Definition><ccts:ObjectClass>Declaration</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class DeclarationType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Declaration. Declaration Type Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the type of this declaration.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Declaration</ccts:ObjectClass><ccts:PropertyTerm>Declaration Type Code</ccts:PropertyTerm><ccts:RepresentationTerm>Code</ccts:RepresentationTerm><ccts:DataType>Code. Type</ccts:DataType></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("DeclarationTypeCode", Namespace="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")]
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.DeclarationTypeCodeType DeclarationTypeCode { get; set; }
