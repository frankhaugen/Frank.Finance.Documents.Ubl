...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    public partial class ItemLocationQuantityType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Lead Time. Measure
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The lead time, i.e., the time taken from the time at which an item is
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.LeadTimeMeasureType LeadTimeMeasure { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Minimum_ Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The minimum quantity that can be ordered to qualify for a specific price.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Maximum_ Quantity. Quantity
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The maximum quantity that can be ordered to qualify for a specific price.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Hazardous Risk_ Indicator. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indication that the transported item, as delivered, in the stated
        ///                                quantity to the stated location, is subject to an international regulation concerning
        ...
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.TradingRestrictionsType> _tradingRestrictions;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Trading Restrictions. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Text describing trade restrictions on the quantity of this item or on the
        ///                                item itself.
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.TradingRestrictionsType> TradingRestrictions
        {
            get
            {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Applicable_ Tax Category. Tax Category
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Allowance Charge
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An allowance or charge associated with this item location quantity.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Item Location Quantity. Dependent Price Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The price of the item as a percentage of the price of some other item.
