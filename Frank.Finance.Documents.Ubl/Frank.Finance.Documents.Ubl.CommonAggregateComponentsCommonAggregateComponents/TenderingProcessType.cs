...
namespace Frank.Finance.Documents.Ubl.CommonAggregateComponentsCommonAggregateComponents
{
    ...
    /// <summary>
    /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ABIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Details</ccts:DictionaryEntryName><ccts:Definition>A class to describe the process of a formal offer and response to execute work or
    ///                        supply goods at a stated price.
    ///                    </ccts:Definition><ccts:ObjectClass>Tendering Process</ccts:ObjectClass></ccts:Component></para>
    /// </summary>
    ...
    public partial class TenderingProcessType
    {
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Original_ Contracting System. Identifier
        ///                            </ccts:DictionaryEntryName><ccts:Definition>When reopening a tendering process, the identifier of the original
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.OriginalContractingSystemIdType OriginalContractingSystemId { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.NegotiationDescriptionType> _negotiationDescription;
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Negotiation_ Description. Text
        ///                            </ccts:DictionaryEntryName><ccts:Definition>Text describing the negotiation to be followed during the tendering
        ///                                process.
        ...
        public List<Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.NegotiationDescriptionType> NegotiationDescription
        {
            get
            {
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ProcedureCodeType ProcedureCode { get; set; }
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.UrgencyCodeType UrgencyCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Expense Code. Code</ccts:DictionaryEntryName><ccts:Definition>A code signifying the type of expense for this tendering process.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ExpenseCodeType ExpenseCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Part Presentation Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the type of presentation of tenders required (e.g., one
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.PartPresentationCodeType PartPresentationCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Contracting System Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the type of contracting system (e.g., framework
        ///                                agreement, dynamic purchasing system). If the procedure is individual (nonrepetitive),
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.ContractingSystemCodeType ContractingSystemCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Submission Method Code. Code
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A code signifying the method to be followed in submitting tenders.
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.SubmissionMethodCodeType SubmissionMethodCode { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Candidate Reduction_ Constraint. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indicator that the number of candidates participating in this process
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.CandidateReductionConstraintIndicatorType CandidateReductionConstraintIndicator { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>BBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Government Agreement_ Constraint. Indicator
        ///                            </ccts:DictionaryEntryName><ccts:Definition>An indicator that the project associated with this tendering process is
        ...
        public Frank.Finance.Documents.Ubl.CommonBasicComponentsCommonBasicComponents.GovernmentAgreementConstraintIndicatorType GovernmentAgreementConstraintIndicator { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Document Availability_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which documents relating to this tendering process must
        ///                                be completed.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Tender Submission Deadline_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which tenders must be delivered.</ccts:Definition><ccts:Cardinality>0..1</ccts:Cardinality><ccts:ObjectClass>Tendering Process</ccts:ObjectClass><ccts:PropertyTermQualifier>Tender Submission Deadline</ccts:PropertyTermQualifier><ccts:PropertyTerm>Period</ccts:PropertyTerm><ccts:AssociatedObjectClass>Period</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Period</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        [XmlElementAttribute("TenderSubmissionDeadlinePeriod")]
        public PeriodType TenderSubmissionDeadlinePeriod { get; set; }
        
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Invitation Submission_ Period. Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which invitations to tender must be completed and
        ///                                delivered.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Participation Request Reception_ Period.
        ///                                Period
        ///                            </ccts:DictionaryEntryName><ccts:Definition>The period during which requests for participation must be completed and
        ///                                delivered.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Notice_ Document Reference. Document
        ///                                Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to a notice pertaining to this tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Additional_ Document Reference. Document
        ///                                Reference
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A reference to an additional document.</ccts:Definition><ccts:Cardinality>0..n</ccts:Cardinality><ccts:ObjectClass>Tendering Process</ccts:ObjectClass><ccts:PropertyTermQualifier>Additional</ccts:PropertyTermQualifier><ccts:PropertyTerm>Document Reference</ccts:PropertyTerm><ccts:AssociatedObjectClass>Document Reference</ccts:AssociatedObjectClass><ccts:RepresentationTerm>Document Reference</ccts:RepresentationTerm></ccts:Component></para>
        /// </summary>
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Process Justification
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A justification for the selection of this tendering process.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Economic Operator Short List
        ///                            </ccts:DictionaryEntryName><ccts:Definition>A set of criteria used to create a short list of candidates.
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Open Tender_ Event. Event
        ...
        /// <summary>
        /// <para><ccts:Component xmlns:ccts="urn:un:unece:uncefact:documentation:2"><ccts:ComponentType>ASBIE</ccts:ComponentType><ccts:DictionaryEntryName>Tendering Process. Auction Terms</ccts:DictionaryEntryName><ccts:Definition>The terms to be fulfilled by tenderers if an auction is to be executed
        ///                                before the awarding of a tender.
