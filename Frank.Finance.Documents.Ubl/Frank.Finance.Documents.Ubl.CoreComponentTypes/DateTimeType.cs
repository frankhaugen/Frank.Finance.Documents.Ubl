...
namespace Frank.Finance.Documents.Ubl.CoreComponentTypes
{
    ...
    /// <para xml:lang="en"><ccts:Definition xmlns:ccts="urn:un:unece:uncefact:documentation:2">A particular point in the progression of time together with the relevant supplementary
    ///                    information.
